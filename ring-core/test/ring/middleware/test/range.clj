...
(deftest wrap-range-header-multiple-ranges-test
  ...
  (testing "string"
    (let [ascii-response {:status 200
                          :body "a body with ASCII characters only"}
          ascii-handler (wrap-range-header (constantly ascii-response) {:boundary-generator-fn (constantly "aboundary")})]
  ...
  (testing "file"
    (let [binary-response {:status 200
          ...
          binary-handler (wrap-range-header (constantly binary-response) {:boundary-generator-fn (constantly "Mp4Boundary34")})]
  ...
  (testing "InputStream"
    (let [response {:status 200
          ...
          handler (wrap-range-header (constantly response) {:boundary-generator-fn (constantly "baaz")})]
      (is (= (handler {:request-method :get
                       :uri "foo.mpeg"
  ...
  (testing "seq of strings"
    (let [response {:status 200
                    :body (seq ["part 1\r\n" "string 2" "abc789"])}
          handler (wrap-range-header (constantly response) {:boundary-generator-fn (constantly "somerandomstring")})]
      (is (= (handler {:request-method :get
                       :uri "foo.png"
...
(deftest wrap-range-header-uses-existing-content-type-header-test
  (let [response {:status 200
        ...
        handler (wrap-range-header (constantly response) {:boundary-generator-fn (constantly "SomeBoundary")})]
    (is (= (handler {:request-method :get
                     :uri "some-video.gif"
